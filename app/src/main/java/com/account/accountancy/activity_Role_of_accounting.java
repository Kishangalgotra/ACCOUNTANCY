...
public class activity_Role_of_accounting extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sdata1 = "Accounting is often called “the language of business.” Why?\n" +
                ...
                "Obviously, you wouldn’t try to run an organization or make investment decisions without accurate and timely financial information, and it’s the accountant who prepares this information.\n\n" +
                ...
                "In any case, we’re now ready to define accounting as the process of measuring and summarizing business activities, interpreting financial information, and communicating the results to management and other decision makers.";
